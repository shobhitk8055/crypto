            ...
            <div class="header-body text-center mb-7">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        ...
                        <p class="text-lead text-white">Join Cryptovests and start earning from day one.</p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Footer -->
<footer id="footer-main" style="background-color: #172B4D;">
    <div class="container">
