...
<div class="wrapper ">
      ...
      -->
        ...
        <div class="sidebar-wrapper" id="sidebar-wrapper">
            <ul class="nav">
                ...
                <li>
                    <a href="{{route('admin.pendingDeposit')}}">
                        <i class="now-ui-icons location_map-big"></i>
                        <p>Deposit Requests</p>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin.dailypst')}}">
                        <i class="now-ui-icons location_map-big"></i>
                        <p>Daily PST</p>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{route('approvedWithdrawal')}}">
    ...
    <div class="main-panel" id="main-panel" style="background-color: #122D4F;">
        <!-- Navbar -->
